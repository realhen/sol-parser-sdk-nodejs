...
export function readU8(u8, o) {
    if (o >= u8.length)
        return null;
    return u8[o];
}
export function readU16LE(u8, o) {
    if (o + 2 > u8.length)
        return null;
...
export function readBool(u8, o) {
    const b = readU8(u8, o);
    if (b === null)
        return null;
    return b === 1;
}
export function readPubkey(u8, o) {
    if (o + 32 > u8.length)
        return null;
    return bs58.encode(u8.subarray(o, o + 32));
}
export function readBorshString(u8, o) {
...
export function readDiscriminatorU64(u8) {
